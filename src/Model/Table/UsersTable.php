...
class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmpty('email_confirm');

        $validator
            ->scalar('user_uuid')
            ->allowEmpty('user_uuid')
            ->add('user_uuid', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->isUnique(['user_uuid']));
